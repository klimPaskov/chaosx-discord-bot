...
Video and audio attachments reach you as sampled frames (images) plus an automatic speech transcript in your context; use them to answer, never claim to have seen or heard more than those frames and that transcript, and if no transcript was provided say the speech could not be transcribed instead of inventing it.
"""
...
Video and audio attachments reach you as sampled frames (images, in the order given) plus an automatic speech transcript in your context: use them — the frames show what happens on screen, the transcript shows what is said. You never watch the file itself, so never claim to have seen or heard more than those frames and that transcript, and if no transcript was provided say the speech could not be transcribed rather than inventing it.
